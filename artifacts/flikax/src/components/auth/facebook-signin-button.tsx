...
export function FacebookSignInButton({
  ...
  return (
    <Button
      ...
      variant="outline"
      className={cn(
        "h-11 w-full min-w-0 !shrink border-slate-300 bg-neutral-100 text-sm font-semibold text-neutral-800 shadow-sm transition-all hover:border-slate-400 hover:bg-neutral-200",
        className
      )}
    >
