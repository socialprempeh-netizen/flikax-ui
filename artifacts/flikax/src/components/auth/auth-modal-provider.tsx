    ...
    <AuthModalContext.Provider value={{ openAuthModal }}>
      ...
      >
        <DialogContent
          ...
          className="inset-x-0 bottom-0 top-auto max-h-[85vh] w-full max-w-full translate-x-0 translate-y-0 gap-0 overflow-y-auto border border-b-0 border-neutral-300 bg-white p-5 shadow-2xl duration-300 data-[state=closed]:slide-out-to-bottom data-[state=closed]:zoom-out-100 data-[state=open]:slide-in-from-bottom data-[state=open]:zoom-in-100 sm:inset-x-auto sm:top-[50%] sm:left-[50%] sm:bottom-auto sm:max-h-[calc(100vh-2rem)] sm:max-w-sm sm:-translate-x-1/2 sm:-translate-y-1/2 sm:border-b sm:p-6 sm:data-[state=closed]:slide-out-to-bottom-0 sm:data-[state=closed]:zoom-out-95 sm:data-[state=open]:slide-in-from-bottom-0 sm:data-[state=open]:zoom-in-95"
        >
