        ...
        {images.length > 1 && (
          <>
            <Button
              ...
              variant="outline"
              size="icon"
              className="glass absolute left-3 top-1/2 hidden -translate-y-1/2 rounded-full !bg-white/80 sm:flex"
            >
            ...
            <Button
              ...
              variant="outline"
              size="icon"
              className="glass absolute right-3 top-1/2 hidden -translate-y-1/2 rounded-full !bg-white/80 sm:flex"
            >
