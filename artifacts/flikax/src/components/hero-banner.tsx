...
// Bottom padding (pb-24/sm:pb-28) is deliberately taller than the top
...
export function HeroBanner() {
  return (
    <div className="w-full bg-brand">
      <div className="mx-auto flex max-w-7xl flex-col items-center px-4 pt-10 pb-24 text-center sm:px-6 sm:pt-14 sm:pb-28">
