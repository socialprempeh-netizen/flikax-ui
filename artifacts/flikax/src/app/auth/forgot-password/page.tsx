...
export default function ForgotPasswordPage() {
  return (
    ...
    <main className="flex min-h-screen items-center justify-center bg-brand p-4 sm:p-8">
      <div className="w-full max-w-md border border-slate-200/80 bg-white p-8 shadow-2xl sm:p-10">
        <FlikaxLogo wordmarkColor="text-brand-dark" iconSize="size-9" wordmarkSize="text-2xl sm:text-3xl" className="mb-6" />
        <ForgotPasswordForm />
      </div>
    </main>
  );
